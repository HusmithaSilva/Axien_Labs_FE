        ...
        <div class="row collapse navbar-collapse" id="navbarTogglerDemo01">
          <ul class="col navbar-nav mt-2 mt-lg-0 ms-2 me-2">
            <li class="nav-item active col-2 ms-4">
              <a class="nav-link text-light" href="/https://main--candid-cocada-ab870b.netlify.app/dashboard">
                DASHBOARD <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item col-1">
              <a class="nav-link text-light" href="/https://main--candid-cocada-ab870b.netlify.app/login">
                SIGNIN
              </a>
            </li>
            <li class="nav-item col-1">
              <a class="nav-link text-light" href="/https://main--candid-cocada-ab870b.netlify.app/signup">
                SIGNUP
              </a>
            </li>
          </ul>
